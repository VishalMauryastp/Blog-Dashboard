      ...
      <div class='relative flex flex-wrap items-center gap-4'>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li class='max-lg:border-b max-lg:py-3 px-3'><a href='/blogs'
        ...
        <div class='flex ml-auto'>
            <a href="/login"> <button class='px-6 py-3 rounded-xl text-white bg-cyan-900 transition-all hover:bg-cyan-800'>Login</button></a>
